...
const getCategoryTone = (label?: string) => {
  ...
  if (normalized.includes("DTAA")) {
    return "border-cyan-200/90 bg-cyan-50 text-cyan-950 shadow-[0_0_20px_rgba(34,211,238,0.16)]";
  }

  if (normalized.includes("FEMA") || normalized.includes("RBI")) {
    return "border-emerald-200/90 bg-emerald-50 text-emerald-950 shadow-[0_0_20px_rgba(16,185,129,0.16)]";
  }

  if (normalized.includes("CBDT")) {
    return "border-amber-200/90 bg-amber-50 text-amber-950 shadow-[0_0_20px_rgba(251,191,36,0.16)]";
  }
  ...
  return "border-sky-200/90 bg-sky-50 text-sky-950 shadow-[0_0_18px_rgba(56,189,248,0.16)]";
};
...
export default function PremiumNewsTicker() {
  ...
  return (
    ...
    >
      ...
      `}</style>
      <div className="absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-cyan-100/50 to-transparent" aria-hidden="true" />
