...
export function TaxUpdates() {
  const updates = [
    ...
    },
    {
      ...
      icon: FileText,
      color: "text-[#2563eb] bg-[#2563eb]/12"
    }
  ];
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {updates.map((update) => {
          ...
          return (
            <Card key={update.id} className="group border-[#E2E8F0] bg-[#F7FAFC]/90 hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
              <CardHeader>
                <div className="flex items-start justify-between mb-2">
                  <div className={`p-3 rounded-lg ${update.color} group-hover:scale-105 transition-transform`}>
              ...
              <CardContent>
                ...
                <p className="text-sm text-[#0F172A]">{update.details}</p>
              </CardContent>
            </Card>
          );
        })}
