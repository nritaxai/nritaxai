...
export default function NewsTicker() {
  ...
  return (
    <div className="nri-home-ticker w-full overflow-hidden border-y border-slate-200 bg-slate-50">
        ...
        {loopItems.map((item, index) => {
          ...
          return (
            <Fragment key={key}>
              ...
              <div className="nri-home-ticker__item inline-flex shrink-0 items-center gap-3 rounded-full border border-slate-200 bg-white px-4 py-2 whitespace-nowrap shadow-sm">
                <span className="nri-home-ticker__label shrink-0 rounded-md bg-slate-900 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-white">
                  {renderTextWithShortForms(item.label || "INTERNATIONAL TAX ALERT")}
                </span>

                <span className="nri-home-ticker__country shrink-0 text-sm font-semibold text-slate-700">
                  {renderTextWithShortForms(item.country || "Cross-Border")}
                </span>

                <span className="nri-home-ticker__divider mx-1 shrink-0 text-slate-300">|</span>

                <span className="nri-home-ticker__type shrink-0 text-sm font-medium text-slate-600">
                ...
                <a
                  ...
                  className="nri-home-ticker__title max-w-[220px] overflow-hidden text-ellipsis whitespace-nowrap text-sm font-semibold text-slate-900 hover:underline md:max-w-[420px]"
                >
                ...
                {item.date ? (
                  <>
                    <span className="nri-home-ticker__divider mx-1 shrink-0 text-slate-300">|</span>
                    <span className="nri-home-ticker__date shrink-0 text-xs font-medium text-slate-500">
