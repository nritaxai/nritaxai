    ...
    <div className="py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-[#2563eb]/12 rounded-full mb-4">
            <Globe2 className="size-8 text-[#2563eb]" />
          </div>
          ...
          {countries.map((country) => (
            <Card
              ...
              className={`cursor-pointer transition-all hover:shadow-lg ${
                selectedCountry === country.code ? 'border-[#2563eb] border-2' : ''
              }`}
            ...
            >
              ...
              <CardContent>
                <p className="text-sm text-[#0F172A]">{country.description}</p>
              </CardContent>
            </Card>
          ))}
        </div>
        ...
        <Card className="max-w-3xl mx-auto mt-12">
          ...
          <CardContent className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 text-[#0F172A] ml-4">
