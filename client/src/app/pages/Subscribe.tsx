    ...
    <div className="py-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-[#0F172A]">Start your subscription today</p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-4">
            {Object.entries(plans).map(([key, plan]) => (
              <Card
                key={key}
                className={`cursor-pointer transition-all ${selectedPlan === key ? 'border-[#2563eb] border-2' : ''}`}
              ...
              >
                <CardHeader>
                  ...
                  <CardDescription>${formatAmount(plan.price)}/month</CardDescription>
                </CardHeader>
              </Card>
            ))}
          </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  >
                    Pay ${formatAmount(plans[selectedPlan as keyof typeof plans].price)}
                  </Button>
